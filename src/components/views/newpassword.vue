    ...
    <div class="login_con boxShadow">
      ...
      <el-form :model="ruleForm" ref="ruleForm" :rules="rules">
        <el-form-item prop="username">
          <el-input placeholder="oldpassword" prefix-icon="fa fa-eye-slash" type="password" v-model="ruleForm.username"></el-input>
        </el-form-item>
    ...
    return {
      ...
      rules: {
        username: [
          ...
          { min: 3, max: 8, message: "最少输入 6 个字符", trigger: "blur" }
        ],
        password: [
